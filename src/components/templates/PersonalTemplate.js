...
export default function PersonalTemplate({ data }) {
        ...
        <div className="container mx-auto px-4 py-2 md:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-4">
              <button 
                onClick={handleWhatsApp}
                className="bg-green-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-green-600 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
              ...
              <button 
                onClick={handleCall}
                className="bg-blue-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
      ...
      <section className="relative py-12 md:py-20 px-4 overflow-hidden" role="banner" aria-label="Hero Section">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 md:mb-8 leading-tight">
              {data.heroTitle}
              <span className="text-blue-600 block">{data.heroSubtitle}</span>
            </h2>
            <p className="text-lg md:text-2xl text-gray-700 mb-8 md:mb-12 leading-relaxed">
